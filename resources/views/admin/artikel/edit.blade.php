            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="file" name="file" class="dropify form-control" data-height="190" data-default-file="{{ asset('foto/guru/artikel/'.$artikel->thumbnail) }}" data-allowed-file-extensions="png jpg gif jpeg svg webp jfif" required>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
